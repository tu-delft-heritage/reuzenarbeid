...
import Map from "https://cdn.skypack.dev/ol@10.8.0/Map.js";
import View from "https://cdn.skypack.dev/ol@10.8.0/View.js";
import VectorSource from "https://cdn.skypack.dev/ol@10.8.0/source/Vector.js";
import VectorLayer from "https://cdn.skypack.dev/ol@10.8.0/layer/Vector.js";
import GeoJSON from "https://cdn.skypack.dev/ol@10.8.0/format/GeoJSON.js";
import TileLayer from "https://cdn.skypack.dev/ol@10.8.0/layer/Tile.js";
import OSM from "https://cdn.skypack.dev/ol@10.8.0/source/OSM.js";
import { defaults as defaultInteractions } from "https://cdn.skypack.dev/ol@10.8.0/interaction.js";
import { Style, Stroke } from "https://cdn.skypack.dev/ol@10.8.0/style.js";
import { getCenter } from "https://cdn.skypack.dev/ol@10.8.0/extent";
import {
  fromLonLat,
  transformExtent,
} from "https://cdn.skypack.dev/ol@10.8.0/proj.js";
import { WarpedMapLayer } from "https://esm.sh/@allmaps/openlayers@1.0.0-beta.84";
...
function animateToGeoJSON(projectId) {
  ...
  const projectFeature = geojson.features.filter(
...
async function showMap(annotationUrl, animateToMapBounds = false) {
  ...
  if (animateToMapBounds) {
    const extent = warpedMapLayer.renderer.warpedMapList.getMapsBbox();
    const view = map.getView();
    const resolution = view.getResolutionForExtent(extent);
    const zoom = view.getZoomForResolution(resolution);
    const center = getCenter(extent);
